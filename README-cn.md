...
希望开发者能将自己界面中的固定部分用GuiLite开发，同时也积极利用MFC，QT，Android，Linux，Windows的界面特性，让自己的界面集百家之长，又不失个性。
...
不推荐大家直接使用GuiLite。为了聚焦UI基本运作原理，GuiLite会一直保持轻量。
